...
<table width="500px" cellspacing="0" cellpadding="0"  style="margin:0 auto;">
    ...
    <tr>
        <td style="background-color:#ffffff;">
            <div style="display: block;	text-align:center; margin: 0px;  padding:20px; padding-top:70px;">
                <img style="width:50px; height:50px;" src="{{asset('images/favicon.ico')}}" alt="Spurt!">
    ...
    @yield('content')
    <tr>
        <td style="padding:40px 0; text-align:center; background-color:#fff; color:#222; font-family: 'Avenir LT Std', sans-serif; ">

            <div style="width:80%; margin: 0 auto; background: #F5F5F5;">
                <div style="padding:40px;">
                    <p style="margin-bottom: 0; color: #3a3636;">For further assistance, kindly send us a mail on</p>
                    <a style="text-decoration: none; color: #121212; max-width: 75%; margin: 0 auto; line-height: 1.5; display: block;" href="mailto:support@spurt.group">support@spurt.group</a>
                </div>
            </div>
