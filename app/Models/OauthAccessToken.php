...
class OauthAccessToken extends Model
{
     ...
     * @param string $guard
     */
    public static function deleteUserAccessToken(int $userID, string $guard = 'spurtx')
    {
     ...
     * @param string $guard
     */
    private static function addGuard(string $bearerToken, string $guard = 'client')
    {
     ...
     * @return array
     */
    public static function createAccessToken(Model $model, string $guard = 'client') : array
    {
